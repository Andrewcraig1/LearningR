...
#Which food associated with the max Ns figure seen  from the summary data.It identifies the row(case).
USDA$Sodium
...
> str((HighSodium))
# change Logic (TRUE FALSE) to a numeric (1,0) with the as.numeric function, and add to USDA data frame
