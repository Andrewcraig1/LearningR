...
# Create the ggplot object with the data and the aesthetic mapping (aes):
# Note: We could use bars, lines, points, or something else.
#This is a big difference between ggplot and regular plotting in R. You can build different types of graphs
#by using the same ggplot object. There's no need to learn one function for bar graphs, a completely different function for line graphs, etc.
...
dev.off()
#note: dev.off() to close the file
